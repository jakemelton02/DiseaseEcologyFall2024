...
2.  **Klepac et al. estimated an R0 of 2.5 for the 2002 Phocine Distemper virus epidemic in\
    ...
    PDV?** - To calculate the proportion of the seal population that should be vaccinated the herd immunity threshold formula should be used. The formula is 1-1/R0 - R0=2.5 - 1-1/2.5=.60 = 60% - Therefore, 60% of the seal population should be vaccinated to prevent future outbreaks of PDV
...
-   SARS-CoV-2: upper right quadrant
    ...
    [DiseaseEcologyFall2024/Figure.jpeg at main · jakemelton02/DiseaseEcologyFall2024](https://github.com/jakemelton02/DiseaseEcologyFall2024/blob/main/Figure.jpeg)
